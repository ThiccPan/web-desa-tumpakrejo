...
@section('content')
  <form action="/admin/berita/store" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="judul" id="" class="@error('judul') is-invalid @enderror form-control" maxlength="255" value="{{ $berita->judul }}">
    ...
    <div class="mb-1">
      ...
      <input type="text" name="penulis" id="penulis" class="form-control @error('penulis') is-invalid @enderror" value="{{ $berita->penulis }}">
