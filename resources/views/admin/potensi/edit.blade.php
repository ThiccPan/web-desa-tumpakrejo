  ...
  <div class="card-body">
    ...
    <form action="/admin/potensi/{{ $potensi->slug }}/update" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <img src="{{ asset('storage/' . $potensi->sampul) }}" alt="Sampul lama tidak ditemukan"
...
<div class="card card-default">
  <div class="card-header pt-4">
    ...
    <form action="/admin/potensi/{{ $potensi->slug }}/gambar/tambah" method="POST" enctype="multipart/form-data"
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      <label for="">Daftar gambar potensi</label>
