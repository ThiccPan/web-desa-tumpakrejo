  ...
  <div class="row justify-content-center mb-5">
    <div class="col-md-8">
      <article>
        ...
        <p class="mt-3">Oleh. <a class="text-decoration-none">{{ $post->penulis }}</a> Tentang <a href="/potensi"
            class="text-decoration-none">Program Desa</a></p>
        <img src="{{ asset('storage/' . $post->sampul) }}" alt="" class="img-fluid" style="max-height: 400px; width:100%; object-fit:cover;">
        <article class="my-3 fs-5">
          <p>Tanggal Mulai Program: <a
              class="text-decoration-none">{{ $post->tanggal }}</a> </p>
        </article>
        <article class="my-3 fs-5">
          <p>{!! $post->deskripsi !!}</p>
        </article>
